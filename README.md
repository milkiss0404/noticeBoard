...
클린아키텍처는 유지보수와 확장에 드는 비용을 줄여주는 구조입니다.<br>
그러면 어떻게 비용을 줄이는게 좋을까?<br>
선택지를 넓혀서, 변화에 유연하게 대응할 수 있게 하기 때문입니다.<br>
...
가장 중요한 원칙은 **고수준 컴포넌트는 저수준 컴포넌트에 의존해서는 안된다** 입니다<br>
...
![image.png](attachment:1e31fffc-14e7-4151-8e51-ec1c60f54a41:image.png) <br>
![image.png](attachment:a307e96a-16ff-452a-8e18-837176a42921:image.png)<br>
